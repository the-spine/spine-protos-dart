...
class AuthServiceClient extends $grpc.Client {
  ...
  static final _$registerUser = $grpc.ClientMethod<$0.UserRegisterRequest, $0.UserRegisterResponse>(
      '/auth.AuthService/RegisterUser',
      ($0.UserRegisterRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.UserRegisterResponse.fromBuffer(value));
  static final _$resetPassword = $grpc.ClientMethod<$0.PasswordResetRequest, $0.PasswordResetResponse>(
      '/auth.AuthService/ResetPassword',
      ($0.PasswordResetRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.PasswordResetResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.UserRegisterResponse> registerUser($0.UserRegisterRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$registerUser, request, options: options);
  }

  $grpc.ResponseFuture<$0.PasswordResetResponse> resetPassword($0.PasswordResetRequest request, {$grpc.CallOptions? options}) {
...
abstract class AuthServiceBase extends $grpc.Service {
  ...
  AuthServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.UserRegisterRequest, $0.UserRegisterResponse>(
        'RegisterUser',
        registerUser_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$0.PasswordResetRequest, $0.PasswordResetResponse>(
        'ResetPassword',
        resetPassword_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.PasswordResetRequest.fromBuffer(value),
  ...
  $async.Future<$0.UserRegisterResponse> registerUser_Pre($grpc.ServiceCall call, $async.Future<$0.UserRegisterRequest> request) async {
    return registerUser(call, await request);
  }

  $async.Future<$0.PasswordResetResponse> resetPassword_Pre($grpc.ServiceCall call, $async.Future<$0.PasswordResetRequest> request) async {
  ...
  $async.Future<$0.UserRegisterResponse> registerUser($grpc.ServiceCall call, $0.UserRegisterRequest request);
  $async.Future<$0.PasswordResetResponse> resetPassword($grpc.ServiceCall call, $0.PasswordResetRequest request);
}
